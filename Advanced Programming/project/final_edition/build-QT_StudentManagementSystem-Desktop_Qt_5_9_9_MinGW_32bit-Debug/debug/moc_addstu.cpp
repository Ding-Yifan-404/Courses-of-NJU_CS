...
#include "../../QT_StudentManagementSystem/addstu.h"
...
QT_MOC_LITERAL(4, 23, 20), // "returnButton_clicked"
QT_MOC_LITERAL(5, 44, 17) // "addButton_clicked"

    },
    "AddStu\0display\0\0number\0returnButton_clicked\0"
    "addButton_clicked"
};
...
void AddStu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (AddStu::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&AddStu::display)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject AddStu::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_AddStu.data,
      qt_meta_data_AddStu,  qt_static_metacall, nullptr, nullptr}
};
