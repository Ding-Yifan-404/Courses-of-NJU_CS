...
#include "../../QT_StudentManagementSystem/querystu.h"
...
QT_MOC_LITERAL(4, 25, 20), // "returnButton_clicked"
QT_MOC_LITERAL(5, 46, 19) // "queryButton_clicked"

    },
    "QueryStu\0display\0\0number\0returnButton_clicked\0"
    "queryButton_clicked"
};
...
void QueryStu::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (QueryStu::*_t)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&QueryStu::display)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject QueryStu::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_QueryStu.data,
